...
package m520it.com.purenba.view;
 ...
 *      complete}
 */
public class TestFragmentTabHost extends TabHost
    ...
    public TestFragmentTabHost(Context context) {
    ...
    public TestFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
